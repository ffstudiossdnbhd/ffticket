...
use FFTicketWeb\Controllers\FaqController;
...
$faqController = new FaqController($view, $api, $auth);
...
$router->post('/activity/heartbeat', [$ticketController, 'heartbeat']);
...
$router->post('/admin/faqs/create', [$adminController, 'createFaq']);
$router->post('/admin/faqs/update', [$adminController, 'updateFaq']);
$router->post('/admin/faqs/delete', [$adminController, 'deleteFaq']);
$router->get('/admin/timeouts', [$adminController, 'timeouts']);
$router->post('/admin/timeouts/save', [$adminController, 'saveTimeout']);
$router->post('/admin/timeouts/release', [$adminController, 'releaseTimeout']);
