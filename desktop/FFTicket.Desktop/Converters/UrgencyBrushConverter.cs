...
public sealed class UrgencyBrushConverter : IValueConverter
{
    ...
    private static readonly SolidColorBrush MediumBrush = CreateBrush(0xA1, 0x62, 0x07);
    private static readonly SolidColorBrush LowBrush = CreateBrush(0x25, 0x63, 0xEB);
