...
try {
    ...
    $stmt = $db->prepare(
        'SELECT t.ticket_number, t.subject, t.status, t.urgency, c.name AS category,
            creator.name AS creator, assignee.name AS assignee, t.created_at, t.closed_at
         FROM tickets t
    ...
    fputcsv($out, ['Ticket Number', 'Subject', 'Status', 'Urgency', 'Category', 'Creator', 'Assignee', 'Created At', 'Closed At']);
